...
JsDemo.main = function() {
	...
	image.onload = function(event3) {
		console.log("image loaded");
		console.log(event3);
		JsDemo.clearCanvas(tinyCanvasPNG);
		...
		var canvasSamplePNGOnClick = function(event4) {
			...
			rect_x2 = 15;
			rect_y2 = 15;
			rect_width2 = tinyCanvasSamplePNG.canvas.width - 30;
			rect_height2 = tinyCanvasSamplePNG.canvas.height - 30;
			if(event4 != null) {
				var rect3 = event4.target.getBoundingClientRect();
